...
//    private void SetupDialogue()
//    {
//        dialogue["explain situation"] = new List<string>();
//        dialogue["explain situation"].Add("Well then! That landing was a bit rougher than I had hoped. I will scan the ship and our current surroundings. (Click to Continue)");
//        dialogue["explain situation"].Add("Scanning . . .");
//        dialogue["explain situation"].Add("Scan complete.");
//        dialogue["explain situation"].Add("Bad news. The ship has sustained substantial damaged and three core components are missing.");
//        dialogue["explain situation"].Add("Good news, the planet is only inhabited by flora. Fauna is not present. You are currently the only living animal to set foot on this planet.");

//        dialogue["explain building placement"] = new List<string>();
//        dialogue["explain building placement"].Add("You are going to need to find those pieces off your ship if we are going to get home. Let me start the back-up generator.");
//        dialogue["explain building placement"].Add("Done. But, it does not look like that will be enough to get us by. You are going to need to build your way out of here.");
//        dialogue["explain building placement"].Add("You see that shiny lump of minerals over there? It is a common resource in our universe, and it is used in most buildings back home.”");

//        dialogue["build cluster fan 1"] = new List<string>();
//        dialogue["build cluster fan 1"].Add("To help you in your journey, I am going to download important building blueprints.");
//        dialogue["build cluster fan 1"].Add("Downloading . . .");
//        dialogue["build cluster fan 1"].Add("Download complete.");
//        dialogue["build cluster fan 1"].Add("The blueprints have been implemented. Click on the icon to open the building menu.");

//        dialogue["build cluster fan 2"] = new List<string>();
//        dialogue["build cluster fan 2"].Add("The first blueprint to be used will be the harvester.");
//        dialogue["build cluster fan 2"].Add("Use the mouse to select the harvester. Other buildings will become available to you once you have enough materials.");

//        dialogue["build cluster fan 3"] = new List<string>();
//        dialogue["build cluster fan 3"].Add("Now, place the harvester on top of the mineral by clicking it.");

//        dialogue["build generator"] = new List<string>();
//        dialogue["build generator"].Add("Great! Seems the bump on your head from the landing did not do as much damage as I thought. Now that you have some minerals, you can build another power generator.");
...
//        {
//            //Activate DialogueBox, passing dialogue to it
//            aiText.ActivateDialogueBox(dialogue[dialogueKey], invokeDelay);
