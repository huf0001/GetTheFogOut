        ...
        switch (gameObject.name)
        {
            case "btn_battery":
                buildingDesc.text = "<b>Battery</b>\n" +
                    $"Build Cost: {build_prefab.GetComponentInChildren<Battery>().MineralCost} <sprite=\"all_icons\" index=3>\n" +
            ...
            case "btn_generator":
                buildingDesc.text = "<b>Power Generator</b>\n" +
                    $"Build Cost: {build_prefab.GetComponentInChildren<Generator>().MineralCost} <sprite=\"all_icons\" index=3>\n" +
            ...
            case "btn_harvester":
                buildingDesc.text = "<b>Elemental Harvester</b>\n" +
                    $"Build Cost: {build_prefab.GetComponentInChildren<Harvester>().MineralCost} <sprite=\"all_icons\" index=3>\n" +
            ...
            case "btn_defence":
                buildingDesc.text = "<b>Cluster Fan</b>\n" +
                    $"Build Cost: {build_prefab.GetComponentInChildren<Defence>().MineralCost} <sprite=\"all_icons\" index=3>\n" +
            ...
            case "btn_relay":
                buildingDesc.text = "<b>Power Relay</b>\n" +
                    $"Build Cost: {build_prefab.GetComponentInChildren<Relay>().MineralCost} <sprite=\"all_icons\" index=3>\n" +
