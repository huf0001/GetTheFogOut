...
Shader "TechArt/Buildings/Buildings"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( Emission91 + ( tex2D( _Emission, uv_Emission ) * _EmmisionStrength ) + Damaged141 + Party166 ).rgb;
...
/*ASEBEGIN
Version=17000
1;1;1364;705;723.5389;140.2251;1;True;True
...
ASEEND*/
//CHKSM=B7ED07E5E3FE8D92273523B08777B680A66896DF