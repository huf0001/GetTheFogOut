...
Shader "TechArt/FogOfWar"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_32_0 = ( 1.0 - ( tex2DNode30.r + ( tex2DNode30.a + -0.2 ) ) );
...
/*ASEBEGIN
Version=17000
1921;1;1918;1017;-292.4438;25.79448;1.3;True;True
...
Node;AmplifyShaderEditor.OneMinusNode;32;1658.298,598.4877;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
