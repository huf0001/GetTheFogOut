...
Shader "TechArt/Buildings/BuildPreview"
{
	...
	SubShader
	{
		...
		{
			float4 color6 = IsGammaSpace() ? float4(1,0.1823467,0,0) : float4(1,0.02786851,0,0);
			...
			o.Albedo = ( color6 * tex2DNode1 ).rgb;
			float4 color12 = IsGammaSpace() ? float4(4,1.113726,0,0) : float4(21.11213,1.267396,0,0);
			...
			o.Emission = ( tex2DNode1 * ( color12 * fresnelNode9 ) ).rgb;
...
/*ASEBEGIN
Version=16800
1418;73;2420;653;2292.985;193.0747;1.3;True;True
Node;AmplifyShaderEditor.SimpleTimeNode;7;-1492.869,223.302;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-1476.869,141.302;Float;False;Property;_ScrollSpeed;ScrollSpeed;1;0;Create;True;0;0;False;0;0.5;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-1421.769,364.702;Float;False;Property;_FresnelPower;Fresnel Power;2;0;Create;True;0;0;False;0;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;12;-1059.869,443.302;Float;False;Constant;_Color0;Color 0;2;1;[HDR];Create;True;0;0;False;0;4,1.113726,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;6;-958.3011,-257.6522;Float;False;Constant;_LineColours;Line Colours;1;1;[HDR];Create;True;0;0;False;0;1,0.1823467,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A0D2AC89AF9E3F2BA4EA198C3E550B05C7D0D2E3