...
Shader "TechArt/Effects/PickupPulse2"
{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float outlineVar = (0.0 + (( lerp(_EdgeWidth,0.0,_TogglePulse) * (0.0 + (sin( mulTime40 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ) - 0.0) * (0.0005 - 0.0) / (1.0 - 0.0));
...
/*ASEBEGIN
Version=16800
2068;73;1770;653;2595.557;322.5312;1.296095;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-908.5953,293.8162;Float;False;Property;_EdgeWidth;Edge Width;14;0;Create;True;0;0;False;0;1;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;48;-630.6719,278.8565;Float;False;Property;_TogglePulse;Toggle Pulse;15;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;37;-260.4532,152.3096;Float;False;Property;_EdgeColour;Edge Colour;13;1;[HDR];Create;True;0;0;False;0;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OutlineNode;38;-18.45258,300.3095;Float;False;0;True;None;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=7DCB35DB7F754CC9352574221992A50E9851FC70