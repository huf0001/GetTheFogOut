...
Shader "TechArt/Collectables"
{
	Properties
	{
		...
		_EdgeWidth("Edge Width", Range( 0 , 750)) = 2
		_PulseSpeed("Pulse Speed", Float) = 20
		[HDR]_OutlineColour("Outline Colour", Color) = (2.670157,2.670157,2.670157,0)
		[Toggle]_Collectable("Collectable", Float) = 1
		[HDR]_Emmission("Emmission", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float outlineVar = (0.0 + (( lerp(0.0,_EdgeWidth,_Collectable) * (0.0 + (sin( mulTime111 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ) - 0.0) * (0.0005 - 0.0) / (1.0 - 0.0));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( Emission91 + ( tex2D( _Emission, uv_Emission ) * _EmmisionStrength * _Emmission ) ).rgb;
...
/*ASEBEGIN
Version=16800
7;8;1906;1011;1335.322;-118.98;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-3506.591,-161.369;Float;False;Property;_Speed;Speed;17;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-3115.593,263.317;Float;False;Property;_Teleport;Teleport;14;0;Create;True;0;0;False;0;-1;-1;-20;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-3092.219,1983.459;Float;False;Property;_EdgeWidth;Edge Width;20;0;Create;True;0;0;False;0;2;350;0;750;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;128;-2787.846,1997.588;Float;False;Property;_Collectable;Collectable;23;0;Create;True;0;0;False;0;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;118;-2372.507,1920.536;Float;False;Property;_OutlineColour;Outline Colour;22;1;[HDR];Create;True;0;0;False;0;2.670157,2.670157,2.670157,0;2.670157,2.670157,2.670157,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;94;-2687.845,996.4406;Float;False;Property;_GlowColour;Glow Colour;13;1;[HDR];Create;True;0;0;False;0;4,0.879581,0,0;4,0.879581,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OutlineNode;120;-2136.257,2057.031;Float;False;1;True;None;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;129;-325.3219,847.98;Float;False;Property;_Emmission;Emmission;24;1;[HDR];Create;True;0;0;False;0;0,0,0,0;2,2,2,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-341.7328,759.5751;Float;False;Property;_EmmisionStrength;Emmision Strength;12;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-89.73312,677.5751;Float;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D5D4C479A9528A4097C5CB00BC595DA444487A5B